...
- **01_data/**: Contains raw and processed data.
  - aw/aadhaar_biometric/: Original datasets.
  - processed/: Cleaned and transformed data.
- **02_notebooks/**: Jupyter notebooks for analysis.
- **03_models/**: Saved models.
- **04_visuals/**: Generated plots and charts.
  - 	rends/
  - heatmaps/
  - nomalies/
  - lifecycle/
- **05_reports/**: Final analysis reports.
