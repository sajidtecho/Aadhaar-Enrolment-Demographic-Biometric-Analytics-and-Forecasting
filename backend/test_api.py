...
def run_checks():
    ...
    try:
        ...
        if resp.status_code == 200:
            ...
            if len(districts) > 0:
                ...
                if sample['district'] == "TestDistrict" or sample['riskScore'] == 12345:
                    print("   ⚠️ ALERT: Mock Data Detected.")
    ...
    payload = {
        ...
        "bio_age_5_17": 12500,
        "bio_age_17_": 45000,
        "lag_1m_bio": 57000, # Providing context to ensure calculation is possible
        "lag_2m_bio": 56000,
        "lag_3m_bio": 55000
    }
